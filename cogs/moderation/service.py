...
#   Save a role option message and its role mappings
# -----------------------------------------------------------------------------
    async def create_role_options(
        ...
        return await repo.create_role_options(
...
# -----------------------------------------------------------------------------
# &&Method role_option
#   Fetch role options for a message
# -----------------------------------------------------------------------------
    async def role_option(
        ...
        repo = await self.repository(guild_id)
        return await repo.role_option(
            message_id,
        )

# -----------------------------------------------------------------------------
# &&Method role_option_by_emoji
#   Fetch a role option by reaction emoji
# -----------------------------------------------------------------------------
    async def role_option_by_emoji(
        ...
        repo = await self.repository(guild_id)
        return await repo.role_option_by_emoji(
            message_id,
            emoji,
        )